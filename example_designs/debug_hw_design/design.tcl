...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of gmm_processor_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins gmm_processor_0/S_AXILITE_CSR]
	connect_bd_net [get_bd_pins gmm_processor_0/s_axilite_csr_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins gmm_processor_0/s_axilite_csr_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins gmm_processor_0/S_AXI_INTR]
	connect_bd_net [get_bd_pins gmm_processor_0/s_axi_intr_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins gmm_processor_0/s_axi_intr_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock, reset & status pins of gmm_processor_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins gmm_processor_0/M_AXIMM_DMA]
	connect_bd_net [get_bd_pins gmm_processor_0/m_aximm_dma_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins gmm_processor_0/m_aximm_dma_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins gmm_processor_0/m_aximm_dma_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins gmm_processor_0/m_aximm_dma_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins gmm_processor_0/m_aximm_dma_init_axi_txn] [ get_bd_pins axi_gpio_out/gpio_io_o ]
	...
	connect_bd_net [get_bd_pins gmm_processor_0/irq] [get_bd_pins axi_gpio_irq/gpio_io_i]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of gmm_processor_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {gmm_processor_0/M_AXIMM_DMA/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_M_AXIMM_DMA_TARGET_SLAVE_BASE_ADDR {0xC0000000} ] [get_bd_cells gmm_processor_0]

	# Copy all address to gmm_processor_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/gmm_processor_v1_0_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_gmm_processor_0_S_AXI_INTR_* ]]
	puts $fp "set s_axi_intr_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_gmm_processor_0_S_AXILITE_CSR_* ]]
	puts $fp "set s_axilite_csr_addr ${offset}"
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/gmm_processor_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "gmm_processor_v1_0_hw_${i}"
