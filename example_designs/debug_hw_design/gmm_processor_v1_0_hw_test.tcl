# Runtime Tcl commands to interact with - gmm_processor_v1_0

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/gmm_processor_v1_0_include.tcl
...
# Test: S_AXILITE_CSR
# Create a write transaction at s_axilite_csr_addr address
create_hw_axi_txn w_s_axilite_csr_addr [get_hw_axis $jtag_axi_master] -type write -address $s_axilite_csr_addr -data $wdata_1
# Create a read transaction at s_axilite_csr_addr address
create_hw_axi_txn r_s_axilite_csr_addr [get_hw_axis $jtag_axi_master] -type read -address $s_axilite_csr_addr
# Initiate transactions
run_hw_axi r_s_axilite_csr_addr
run_hw_axi w_s_axilite_csr_addr
run_hw_axi r_s_axilite_csr_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_s_axilite_csr_addr]]
# Compare read data
if { $rdata_tmp == $wdata_1 } {
	puts "Data comparison test pass for - S_AXILITE_CSR"
} else {
	puts "Data comparison test fail for - S_AXILITE_CSR, expected-$wdata_1 actual-$rdata_tmp"
	inc ec
}
...
# Test: M_AXIMM_DMA
set wdata_m_aximm_dma [get_init_data 0]
create_hw_axi_txn w_m_aximm_dma_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_m_aximm_dma}
create_hw_axi_txn r_m_aximm_dma_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
# Initiate transactions
run_hw_axi r_m_aximm_dma_addr
run_hw_axi w_m_aximm_dma_addr
run_hw_axi r_m_aximm_dma_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_m_aximm_dma_addr]]
set DE [ get_done_and_error_bit $rdata_tmp 1 0 ]
# Compare read data
if { $DE == 01 } {
	puts "Data comparison test pass for - M_AXIMM_DMA"
} else {
	puts "Data comparison test fail for - M_AXIMM_DMA, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}
